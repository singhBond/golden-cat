...
export const CategorySidebar: React.FC<Props> = ({
  ...
  return (
    <aside className="w-24 sm:w-40 md:w-32 sticky top-28 h-[calc(100vh-8rem)] overflow-y-auto bg-linear-to-r from-yellow-950 via-yellow-800 to-yellow-600 border-r rounded-xl shadow-sm p-2 scrollbar-thin">
          ...
          <div
            ...
            className={`flex flex-col items-center cursor-pointer rounded-xl px-8 py-2 mb-2 transition-all border ${
              activeCategory === cat.id
                ? "bg-orange-500 border-orange-400 shadow-lg scale-110"
                : "hover:bg-orange-700 border-transparent"
            }`}
          >
